...
var getAllCategories = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, Category_1.default.find().sort({ name: 1 })];
            case 1:
                categories = _a.sent();
                res.json({
                    success: true,
...
var createCategory = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var newCategory, slug, category, error_2;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                ...
                return [4 /*yield*/, Category_1.default.create(__assign(__assign({}, newCategory), { slug: slug }))];
            case 1:
                category = _a.sent();
...
var getCategoryById = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, Category_1.default.findById(req.params.id)];
            case 1:
                category = _a.sent();
                if (!category) {
...
var updateCategoryById = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, Category_1.default.findByIdAndUpdate(req.params.id, req.body, {
                        new: true,
                    })];
            case 1:
                category = _a.sent();
...
var deleteCategoryById = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, Category_1.default.findByIdAndDelete(req.params.id)];
            case 1:
                category = _a.sent();
                if (!category) {
                    throw new not_found_error_1.default("Category not found");
